...
def get_users_ldap():
    ...
    pg_u_groups = [
        'АХС (AHS)', 'Бухгалтерия', 'Коммерческий отдел', 'Мебельный цех',
        'Оптовый склад (OPT)', 'ОСБ', 'Отдел закупок',
        'Отдел маркетинга (MRK)', 'Отдел обучения', 'Отдел персонала (PERS)',
        'Отдел подбора персонала (PODP)',
        'Отдел разработки программного обеспечения (PROG)',
        'Отдел системного администрирования (IT)',
        'Отдел собственной торговой марки', 'Рождественская Набережная',
        'Руководство', 'Супервайзеры', 'Финансово-экономический отдел (FIN)',
        'Юридический отдел (YUR)'
    ]
